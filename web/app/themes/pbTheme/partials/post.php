<article class="flex flex-col items-start justify-between rounded-2xl shadow border border-gray-200">
    <div class="relative w-full">
        <a href="<?php the_permalink() ?>" class="hover:text-gray-900">
            <?php the_post_thumbnail('post-thumbnail', ['class' => 'aspect-[16/9] w-full rounded-t-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2]']) ?>
