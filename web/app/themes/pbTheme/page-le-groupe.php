    ...
    <div class="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-12 bg-white py-12 px-6 rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <a href="/notre-responsabilite-employeur" class="mt-6 inline-block bg-indigo-dye  text-white py-3 px-6 rounded-lg ease-in-out duration-500  hover:bg-picton-blue">En savoir plus sur Notre Responsabilité Employeur</a>
                </div>
        ...
        <section class="mb-12 bg-white py-12 px-6 rounded-lg">
            ...
            <div class="text-center mt-8">
                <a href="/nos-demarches-responsable" class="mt-6 inline-block bg-indigo-dye ease-in-out duration-500 text-white py-3 px-6 rounded-lg shadow-lg hover:bg-picton-blue">En savoir plus sur Nos Démarches Responsables</a>
            </div>
        </section>
    </div>
</main>
